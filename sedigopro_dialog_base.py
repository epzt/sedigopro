...
class Ui_sediGoProDialogBase(object):
    def setupUi(self, sediGoProDialogBase):
        ...
        self.splitter_3.setGeometry(QtCore.QRect(10, 61, 281, 24))
        self.splitter_3.setOrientation(QtCore.Qt.Horizontal)
        self.splitter_3.setObjectName("splitter_3")
        self.textTagColorLabel = QtWidgets.QLabel(self.splitter_3)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.textTagColorLabel.setFont(font)
        self.textTagColorLabel.setObjectName("textTagColorLabel")
        self.whiteTagTextButton = QtWidgets.QPushButton(self.splitter_3)
        palette = QtGui.QPalette()
        ...
        self.blackTagTextButton = QtWidgets.QPushButton(self.splitter_3)
        palette = QtGui.QPalette()
